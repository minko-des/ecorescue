<section class="p-contact-banner">
    <h2 class="banner-title"><span class="u-nowrap">お問合せ・お見積り ２４時間３６５日</span><span class="u-nowrap">いつでも受付中です！</span></h2>
    <div class="banner-content">
        <div class="main-info">
            <img class="character" src="<?php echo esc_url(get_theme_file_uri('/images/character_04.png') ); ?>" alt="イメージキャラクター「エコわんくん」">
        ...
        <div class="btn-wrap">
            <div class="js-link-btn__contact">
                <a href="<?php echo esc_url(home_url('/contact-form/')); ?>" aria-label="お問合せフォームへ" role="button">
                    <div class="head">
                        <img class="icon" src="<?php echo esc_url(get_theme_file_uri('/images/contact-icon.png') ); ?>" alt="コンタクトフォームアイコン">
